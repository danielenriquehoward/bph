<?php
  ...
  $context['mailchimpintegration'] = get_field('mailchimp_integration', 'option');
  $context['globalfeaturedguide'] = get_field('global_featured_guide', 'option');
  $context['guidesubtitle'] = get_field('guide_subtitle', 'option');
  $context['ctatext'] = get_field('cta_text', 'option');
  $context['shelftitle'] = get_field('shelf_title', 'option');
  $context['sponsorsrelationship'] = get_field('sponsors_relationship', 'option');

  $context['contactphone'] = get_field('contact-phone', 'option');
  $context['logolightmobile'] = get_field('logo-light-mobile', 'option');
  $context['logolight'] = get_field('logo-light', 'option');
  $context['logodark'] = get_field('logo-dark', 'option');
  $context['logodarkmobile'] = get_field('logo-dark-mobile', 'option');
